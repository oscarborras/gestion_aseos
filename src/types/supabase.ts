  ...
  public: {
    Tables: {
      ...
      aseos: {
        ...
        Relationships: [
          {
            foreignKeyName: "aseos_estado_id_fkey"
            columns: ["estado_id"]
      ...
      lista_espera: {
        ...
        Relationships: [
          {
            foreignKeyName: "lista_espera_alumno_id_fkey"
            columns: ["alumno_id"]
      ...
      registros: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "registros_aseo_id_fkey"
            columns: ["aseo_id"]
            referencedRelation: "aseos"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      user_roles: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "user_roles_perfil_id_fkey"
            columns: ["perfil_id"]
